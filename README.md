...
| **[holu-project-setup](skills/holu-project-setup/SKILL.md)** | Bootstrapping projects with `@holu/cli` (`dm`), project templates (REST, tRPC), minimal single-file apps, and development workflows. |
